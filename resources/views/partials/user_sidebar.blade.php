        ...
        <ul class="navbar-nav">
                    ...
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('exhibitor_manual') }}">
                                ...
                                <span class="sidenav-normal ms-1 ps-1">Exhibtior Manual</span>
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#pagesExamples" class="nav-link" aria-controls="pagesExamples"
                   ...
                   style="background: linear-gradient(to right, #6366F1, #A5B4FC); border-radius: 8px; margin: 5px 10px; box-shadow: 0 2px 5px rgba(99, 102, 241, 0.3);">
