                            ...
                            <table class="table table-flush mb-0">
                                <thead class="thead-light table-dark">
                                    <tr>
                                        ...
                                        <th class="text-left  text-uppercase text-white text-md font-weight-bolder ps-2">Receipt ID</th>
                                        <th class="text-left  text-uppercase text-white text-md font-weight-bolder  ps-2">Type</th>
...
{{--                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Partial Paid </th>--}}
                                     {{--   <th class="text-left  text-uppercase text-white text-md font-weight-bolder  ps-2">Pending Amount </th> --}}
                                        ...
                                        <th class="text-left  text-uppercase text-white text-md font-weight-bolder  ps-2">View</th> 
        ...
        {{ ucfirst($invoice->payment_status) }}
                                            ...
                                            <td class="text-left text-dark text-md">
                                                @if($invoice->type == 'Stall Booking')
                                                    <a href="{{ route('invoice.mail.view', $invoice->application_no) }}" class="btn btn-sm btn-info" target="_blank">
                                                        View
                                                    </a>
                                                    @elseif($invoice->type == 'Co-Exhibitor')
                                                    <a href="{{ route('co-invoice.mail.view', $invoice->co_exhibitorID) }}" class="btn btn-sm btn-info" target="_blank">
                                                        View
                                                    </a>
                                                @else
                                                    <a href="{{ route('extra-requirements.email', $invoice->invoice_no) }}" class="btn btn-sm btn-info" target="_blank">
                                                        View
                                                    </a>
                                                @endif

                                                @if($invoice->payment_status == 'unpaid')
                                                    <a href="{{ route('paypal.form', $invoice->invoice_no) }}" class="btn btn-sm btn-success" target="_blank">
                                                        Pay Now
                                                    </a>
                                                @endif
                                            </td>
