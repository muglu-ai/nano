...
<table class="table table-hover" id="datatable-basic3">
    <thead>
        <tr>
            <th style="width: 50px; white-space: normal;">Unique ID</th>
            ...
            <th class="text-end" style="width: 100px; white-space: normal;">Actions</th>
        </tr>
    </thead>
    <tbody>
                ...
                <td style="width: 200px; white-space: normal; word-break: break-word;">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div>
    {{ $entry->full_name }}
    <a href="{{ route('exhibitor.pdf', ['id' => $entry->unique_id]) }}" target="_blank" class="ms-2 text-primary" title="View PDF">
