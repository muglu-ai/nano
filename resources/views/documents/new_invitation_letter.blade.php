...
<div id="letter-print">
  ...
  <div class="body-text">
    ...
    <p>
      This is to certify that <strong>{{$data['companyName']}}</strong> is participating as an {{$data['type']}} in <strong>SEMICON India 2025</strong>, scheduled to be held at <strong>Yashobhoomi-IICC, Convention Centre, Dwarka, New Delhi, India</strong>, from <strong>September 2nd to 4th, 2025</strong>.
    </p>
