    ...
    <span class="text-success">{{ $approvedCoexhibitorCount }}</span>
                                ...
                                <div class="card-footer p-2 ps-3">
                                    <p class="mb-0 text-sm">
                                        ...
                                        <span class="text-warning font-weight-bolder">Pending review</span> </a> — Click here for more information.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-header p-2 ps-3">
                                    ...
                                    <p class="mb-0 text-sm">
                                        ...
                                        <span class="text-warning font-weight-bolder">Click Here</span> </a> — for more information.
                                    </p>
                                </div>
