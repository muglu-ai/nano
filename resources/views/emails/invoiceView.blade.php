...
<tr>
    <td style="padding: 0;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
            <tr>
                <td width="50%" style="padding: 12px 20px; border: 1px solid #dddddd;"><strong>Amount Received:</strong></td>
                <td width="50%" style="padding: 12px 20px; border: 1px solid #dddddd; color: #27ae60; font-weight: bold;">
