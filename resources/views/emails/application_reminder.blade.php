...
<html>
<head>
    <title>Application Reminder - SEMICON India 2025</title>
</head>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; max-width: 600px; margin: 20px auto; padding: 20px; border-radius: 5px; box-shadow: 0px 0px 10px #cccccc;">
    <tr>
        <td align="center" style="padding-bottom: 20px;">
            <!-- Logo Placeholder -->
            <img src="https://semicon.interlinks.in//asset/img/logos/logo.png" alt="SEMICON India 2025" style="max-width: 150px; margin-bottom: 20px;">
            <div class="logo-text" style="margin-top: 10px;">SEMICON India 2025</div>
        </td>
    </tr>
    <tr>
        <td>
            ...
            <p style="line-height: 1.6; font-weight: bold;">SEMICON India 2025</p>
        </td>
    </tr>
</table>
</body>
